                ...
                <div class="row">
                    ...
                    <div class="col-md-6 mb-3">
                        <div class="form-group{{ $errors->has('email') ? ' has-danger' : '' }}">
                            ...
                            placeholder="{{ __('Email address') }}" value="{{ old('email', $user->email) }}" required="">
                        </div>
                    </div>
                </div>
                ...
                <div class="row mt-3">
                    <div class="col-md-6 mb-3">
                        <div class="form-group">
                            ...
                            <input id="current_password" name="current_password" type="text" class="form-control" placeholder="Csak változás esetén szükséges megadni!">
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-md-3 mb-3">
                        <div class="form-group">
                            ...
                            <input id="password" name="password" type="text" class="form-control" placeholder="Csak változás esetén szükséges megadni!">
                        </div>
                    </div>
                    <div class="col-md-3 mb-3">
                        <div class="form-group">
                    ...
                    <select class="form-control" 
                        ...
                        @foreach($all_roles_in_database as $role)
                            <option value="{{ $role->id }}"
                                {{ in_array($role->name, $user->roles->pluck('name')->toArray()) 
                                    ? 'selected'
                                    : '' }}>{{ $role->name }}</option>
                        @endforeach
                    </select>
